...
public class DeviceUtils {
     ...
     * @return
     */
    public static String getUserAgent(Context context,boolean channel) {
...
//        String appVersion = pinfo.versionName+"/"+pinfo.versionCode;
        ...
        if (channel) {
            return "QDDISPApp/" + pinfo.versionName + " (" + pinfo.versionCode + "; " + osVersion + "; " + device + ")";

        }
        return "DISPApp/" + pinfo.versionName + " (" + pinfo.versionCode + "; " + osVersion + "; " + device + ")";
    }
