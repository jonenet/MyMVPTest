...
public final class Message implements Parcelable {
     ...
     * @return A Message object from the global pool.
     */
    public static Message obtain(IHandler v) {
        Message m = obtain();
        m.target = v;
        return m;
    }

    public static Message obtain(IHandler v, Object obj) {
        Message m = obtain();
        m.target = v;
        m.obj = obj;
        return m;
    ...
    public static Message obtain(IHandler v, Object[] objs) {
        Message m = obtain();
        m.target = v;
        m.objs = objs;
        return m;
    ...
    public static Message obtain(IHandler v, Class presenter) {
        Message m = obtain();
        m.target = v;
    ...
    public static Message obtain(IHandler v, Object obj, Class presenter) {
        Message m = obtain();
        m.target = v;
        m.obj = obj;
        m.presenter = presenter.getSimpleName();
    ...
    public static Message obtain(IHandler v, Object[] objs, Class presenter) {
        Message m = obtain();
        m.target = v;
        m.objs = objs;
        m.presenter = presenter.getSimpleName();
     ...
     * @return A Message object from the global pool.
     */
    public static Message obtain(IHandler v, int what) {
        Message m = obtain();
        m.target = v;
        m.what = what;
     ...
     * @return A Message object from the global pool.
     */
    public static Message obtain(IHandler v, int what, Object obj) {
        Message m = obtain();
        m.target = v;
        m.what = what;
        m.obj = obj;
     ...
     * @return A Message object from the global pool.
     */
    public static Message obtain(IHandler v, int what, int arg1, int arg2) {
        Message m = obtain();
        m.target = v;
        m.what = what;
        m.arg1 = arg1;
    ...
    public void setTarget(IHandler target) {
        this.target = target;
    }
     ...
     * 分发消息(这里需要自己切换线程),调用 {@link com.jess.arms.base.delegate.IHandler#handleMessage(Message)} 处理消息后
    ...
    /**
     * 分发消息(这里需要自己切换线程),调用 {@link IHandler#handleMessage(Message)} 处理消息后
     * 将消息放入消息池,供下次 {@link #obtain()}
     */
    public void handleMessageToTarget() {
        if (target == null) throw new IllegalArgumentException("target is null");
     ...
     * 分发消息(这里需要自己切换线程),调用 {@link IHandler#handleMessage(Message)} 处理消息
     */
    @Deprecated
