...
/**
 * Created by ex-zhoulai on 2018/3/28.
 */
...
//                        fvh.tv_footer.setTextContent(mContext.getResources().getString(R.string.state_network_error));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    case STATE_LOAD_MORE:
                    case STATE_LOADING:
//                        fvh.tv_footer.setTextContent(mContext.getResources().getString(R.string.state_loading));
                        fvh.pb_footer.setVisibility(View.VISIBLE);
                        break;
                    case STATE_NO_MORE:
//                        fvh.tv_footer.setTextContent(mContext.getResources().getString(R.string.state_not_more));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    case STATE_REFRESHING:
//                        fvh.tv_footer.setTextContent(mContext.getResources().getString(R.string.state_refreshing));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    case STATE_LOAD_ERROR:
//                        fvh.tv_footer.setTextContent(mContext.getResources().getString(R.string.state_load_error));
                        fvh.pb_footer.setVisibility(View.GONE);
                        break;
                    case STATE_HIDE:
...
//        public DTextView tv_footer;

        public FooterViewHolder(View view) {
            super(view);
//            pb_footer = (ProgressBar) view.findViewById(R.id.pb_footer);
//            tv_footer = (DTextView) view.findViewById(R.id.tv_footer);
        }
    }
