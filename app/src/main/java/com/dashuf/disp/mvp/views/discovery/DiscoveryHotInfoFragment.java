...
public class DiscoveryHotInfoFragment extends BaseRecyclerFragment<DiscoveryItemBean> {
    ...
    public void onRefreshSuccess() {
        ...
        if (null != headItemBean) {
            ((DiscoveryHotInfoAdapter) adapter).setHeadBean(headItemBean);
            adapter.removeHeader((RecyclerArrayAdapter.ItemView) adapter);
            adapter.addHeader((RecyclerArrayAdapter.ItemView) adapter);
        }
    }
