...
public class CreditCardDao extends AbstractDao<CreditCard, Long> {
    ...
    private Query<CreditCard> student_CreditCardListQuery;
    ...
    /** Internal query to resolve the "creditCardList" to-many relationship of Student. */
    public List<CreditCard> _queryStudent_CreditCardList(Long id) {
        synchronized (this) {
            if (student_CreditCardListQuery == null) {
                QueryBuilder<CreditCard> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Id.eq(null));
                student_CreditCardListQuery = queryBuilder.build();
            }
        }
        Query<CreditCard> query = student_CreditCardListQuery.forCurrentThread();
