...
public class ClassicsFooter extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    private String REFRESH_FOOTER_PULLING = null;//"上拉加载更多";
    private String REFRESH_FOOTER_RELEASE = null;//"释放立即加载";
    private String REFRESH_FOOTER_LOADING = null;//"正在加载...";
    private String REFRESH_FOOTER_REFRESHING = null;//"正在刷新...";
    private String REFRESH_FOOTER_FINISH = null;//"加载完成";
    private String REFRESH_FOOTER_FAILED = null;//"加载失败";
    private String REFRESH_FOOTER_NOTHING = null;//"没有更多数据了";
    ...
    public ClassicsFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setPadding(thisView.getPaddingLeft(), mPaddingTop = density.dip2px(15), thisView.getPaddingRight(), mPaddingBottom = density.dip2px(15));
        ta.recycle();
...
//    }
    ...
    public void setNoMoreDataText(String noMoreDataText) {
        if (null != mTitleText) {
            REFRESH_FOOTER_NOTHING = noMoreDataText;
